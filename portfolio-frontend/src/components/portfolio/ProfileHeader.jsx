...
const ProfileHeader = ({ profile, socialLinks }) => {
  // Define SVG icons for common platforms
  const getSocialIcon = (platform) => {
    switch(platform.toLowerCase()) {
      ...
      default:
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="h-5 w-5 fill-current">
        ...
        <div className="text-center md:text-left">
          ...
          {profile.cv_url && (
            <a 
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-block mt-2 mb-4 bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-4 rounded transition-colors"
            >
              <span className="inline-flex items-center">
